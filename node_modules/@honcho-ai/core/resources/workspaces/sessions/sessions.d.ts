...
import { Message, MessageCreate, MessageCreateParams, MessageCreateResponse, MessageListParams, MessageUpdateParams, MessageUploadParams, MessageUploadResponse, Messages, MessagesPage } from "./messages.js";
import * as PeersAPI from "./peers.js";
import { PeerAddParams, PeerListParams, PeerRemoveParams, PeerSetConfigParams, PeerSetParams, Peers, SessionPeerConfig } from "./peers.js";
...
export declare class Sessions extends APIResource {
     ...
     */
    update(workspaceId: string, sessionId: string, body: SessionUpdateParams, options?: Core.RequestOptions): Core.APIPromise<Session>;
    /**
     * Get all Sessions for a Workspace, paginated with optional filters.
     */
    list(workspaceId: string, params?: SessionListParams, options?: Core.RequestOptions): Core.PagePromise<SessionsPage, Session>;
     ...
     */
    clone(workspaceId: string, sessionId: string, params?: SessionCloneParams, options?: Core.RequestOptions): Core.APIPromise<Session>;
     ...
     */
    context(workspaceId: string, sessionId: string, query?: SessionContextParams, options?: Core.RequestOptions): Core.APIPromise<SessionContextResponse>;
    context(workspaceId: string, sessionId: string, options?: Core.RequestOptions): Core.APIPromise<SessionContextResponse>;
    /**
     ...
     */
    getOrCreate(workspaceId: string, body: SessionGetOrCreateParams, options?: Core.RequestOptions): Core.APIPromise<Session>;
    /**
     * Search a Session with optional filters. Use `limit` to control the number of
     * results returned.
     */
    search(workspaceId: string, sessionId: string, body: SessionSearchParams, options?: Core.RequestOptions): Core.APIPromise<SessionSearchResponse>;
    /**
     ...
     */
    summaries(workspaceId: string, sessionId: string, options?: Core.RequestOptions): Core.APIPromise<SessionSummariesResponse>;
}
export declare class SessionsPage extends Page<Session> {
}
...
export interface SessionGetOrCreateParams {
    ...
    peers?: {
        [key: string]: PeersAPI.SessionPeerConfig;
    } | null;
}
...
export declare namespace Sessions {
    export { type Session as Session, type SessionConfiguration as SessionConfiguration, type Summary as Summary, type SessionDeleteResponse as SessionDeleteResponse, type SessionContextResponse as SessionContextResponse, type SessionSearchResponse as SessionSearchResponse, type SessionSummariesResponse as SessionSummariesResponse, SessionsPage as SessionsPage, type SessionUpdateParams as SessionUpdateParams, type SessionListParams as SessionListParams, type SessionCloneParams as SessionCloneParams, type SessionContextParams as SessionContextParams, type SessionGetOrCreateParams as SessionGetOrCreateParams, type SessionSearchParams as SessionSearchParams, };
    export { Messages as Messages, type Message as Message, type MessageCreate as MessageCreate, type MessageCreateResponse as MessageCreateResponse, type MessageUploadResponse as MessageUploadResponse, MessagesPage as MessagesPage, type MessageCreateParams as MessageCreateParams, type MessageUpdateParams as MessageUpdateParams, type MessageListParams as MessageListParams, type MessageUploadParams as MessageUploadParams, };
    export { Peers as Peers, type SessionPeerConfig as SessionPeerConfig, type PeerListParams as PeerListParams, type PeerAddParams as PeerAddParams, type PeerRemoveParams as PeerRemoveParams, type PeerSetParams as PeerSetParams, type PeerSetConfigParams as PeerSetConfigParams, };
}
