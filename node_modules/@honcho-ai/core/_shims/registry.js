...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import '@honcho-ai/core/shims/${shims.kind}'\` before importing anything else from @honcho-ai/core`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import '@honcho-ai/core/shims/${shims.kind}'\` after \`import '@honcho-ai/core/shims/${exports.kind}'\``);
    }
